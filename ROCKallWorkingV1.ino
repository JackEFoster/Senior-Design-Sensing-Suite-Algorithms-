...
//capacitor timer
const unsigned long chargeTime = 6000;
...
*/
  ...
  */
  ...
  Serial.print(" magThresh:");
  Serial.println(thresh);
  Serial.print(" fftthresh23:");
  Serial.print(fftthresh23, 5);
  Serial.print(" fftthresh33:");
  Serial.println(fftthresh33, 5);
